...
class PlumberRegistrationPage extends StatefulWidget {
  ...
  PlumberRegistrationPage({super.key});
  @override
  State<PlumberRegistrationPage> createState() =>
      _PlumberRegistrationPageState();
}
...
class _PlumberRegistrationPageState extends State<PlumberRegistrationPage> {
  ...
  Future<List<Map<String, String>>> getCities() async {
    setState(() {});
    String apiURL =
        "https://cqpplefitting.com/ad_cqpple/Api/City/ADMIN123123/$selectedStateID";
    var res = await http.get(Uri.parse(apiURL));
