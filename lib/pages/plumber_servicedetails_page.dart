...
class PlumberServiceDetailsPage extends StatefulWidget {
  ...
  PlumberServiceDetailsPage({complainNumber = "0"}){
  ...
  @override
  State<PlumberServiceDetailsPage> createState() => _PlumberServiceDetailsPageState();
}
              ...
              children: [
                Container(
                  ...
                  child: FutureBuilder(builder: (context, snapshot) {
                    if(snapshot.hasData && snapshot.data.toString()!="Completed"){
                      return SingleChildScrollView(
                        child: Container(
                          margin:
                          const EdgeInsets.only(left: 33, right: 33, top: 30),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              CustomTextStyle(title: "Service Details",),
                              Center(
                                child: Container(
                                  height: 120,
                            ...
                            videoFile == null
                              ...
                              CustomSubmitBotton(margin_top: 70,title: "Submit",
                                onTap: () async {
                                if(videoFile!=null && imageFile!=null && imageSize<10000000 && videoSize<15000000){
                    ...
                    else if(snapshot.hasError || snapshot.data.toString()=="Completed"){
                      return Container(
